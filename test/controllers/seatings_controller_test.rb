...
class SeatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seating" do
    assert_difference("Seating.count") do
      post seatings_url, params: { seating: { screen_id: @seating.screen_id, seat_code: @seating.seat_code } }
    end
  ...
  test "should update seating" do
    patch seating_url(@seating), params: { seating: { screen_id: @seating.screen_id, seat_code: @seating.seat_code } }
