...
class TheatresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theatre" do
    assert_difference("Theatre.count") do
      post theatres_url, params: { theatre: { location: @theatre.location, theatre_name: @theatre.theatre_name } }
    end
  ...
  test "should update theatre" do
    patch theatre_url(@theatre), params: { theatre: { location: @theatre.location, theatre_name: @theatre.theatre_name } }
