...
class SnacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snack" do
    assert_difference("Snack.count") do
      post snacks_url, params: { snack: { price: @snack.price, snack_name: @snack.snack_name } }
    end
  ...
  test "should update snack" do
    patch snack_url(@snack), params: { snack: { price: @snack.price, snack_name: @snack.snack_name } }
